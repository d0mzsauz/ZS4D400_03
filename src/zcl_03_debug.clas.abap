...
CLASS ZCL_03_DEBUG IMPLEMENTATION.
...
**********************************************************************
    ...
    CONSTANTS payment_month     TYPE t_amount     VALUE '5000.00'.
    CONSTANTS spec_repay_year   TYPE t_amount     VALUE '10000.00'.  " Extra payment per year
    CONSTANTS spec_repay_mode   TYPE c LENGTH 1   VALUE 'H'.         "'A' Annual, 'H' every half year, 'Q' 'every Quarter
